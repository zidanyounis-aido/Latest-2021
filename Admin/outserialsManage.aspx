<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/SettingsNestedMaster.Master" AutoEventWireup="true" CodeBehind="outserialsManage.aspx.cs" Inherits="dms.Admin.outserialsManage" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="pageTitle" runat="server">
    ...
    <ul class="pages_nav">
        ...
        <li><a href="../admin/outserialsManage.aspx?CODEN=38"><%= (Session["lang"].ToString() == "0") ? " Outgoing Settings" : "اعدادات الصادر "%></a></li>
    </ul>
</asp:Content>
        ...
        <div class="max-width-holder">
            ...
            <div class="col-xs-4" style="display: none">
                <div class="main-field-holder ">
                    ...
                    <asp:TextBox ID="txtID" ClientIDMode="Static" runat="server" CssClass="main-input" ></asp:TextBox>
                </div>
            </div>
            <!-- folder -->
            ...
            <div class="col-xs-4">
                <div class="main-field-holder ">
                    ...
                    <asp:DropDownList ClientIDMode="Static" ID="drpFoldersSerial" CssClass="new-drop" runat="server">
                    </asp:DropDownList>
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="*" ForeColor="Red" 
                        ControlToValidate="drpFoldersSerial" ValueToCompare="0" Operator="Equal"></asp:CompareValidator>
                </div>
            </div>
            <div class="col-xs-4"></div>
            <!-- list od drops -->
