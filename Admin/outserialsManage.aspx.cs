...
namespace dms.Admin
{
    public partial class outserialsManage : System.Web.UI.Page
    {
        ...
        public void fillDrops(string serial = "",string text="", int folderId = 0)
        {
            ...
            listItems.Add(new ListItem() { Text = "التسلسل", Value = "id" });
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            if (txtID.Text == "0") // this add
            {
                    ...
                    string query = "INSERT INTO IngoingOutgoingSerials (SerialCode,FolderID,Serial,[Type]) Values  ('" + code + "', " + drpFoldersSerial.SelectedValue + ",N'" + serial + "', 1)";
                    c.NonQuery(query);
            ...
            else // this edit
            {
                ...
                string query = "Update IngoingOutgoingSerials set SerialCode='" + code + "', FolderId=" + drpFoldersSerial.SelectedValue + ", Serial=N'" + serial + "', Type=1 where Id=" + txtID.Text;
                c.NonQuery(query);
            }
            divDetails.Visible = false;
            divList.Visible = true;
