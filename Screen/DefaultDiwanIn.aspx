<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/DiwanMaster.master" AutoEventWireup="true" CodeBehind="DefaultDiwanIn.aspx.cs" Inherits="dms.Screen.DefaultDiwanIn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageTitle" runat="server">
    <ul class="pages_nav">
        ...
        <li><a><%= (Session["lang"].ToString() == "0") ? "Recent Documents" : " الوارد"%></a></li>
    </ul>
</asp:Content>
