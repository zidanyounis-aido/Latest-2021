...
namespace dms.Screen
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void fillDocuments(string cond = "", Int32 PageIndex = 1,bool ignoreDelayed=false)
        {
            string fldrs = "";
        ...
        {
            fillDocuments("docName like N'%" + txtSearch.Text + "%'");
        }
        ...
        protected void ddlStatusFilter_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            fillDocuments(cond, 1, ignoreDelayed);
        }
