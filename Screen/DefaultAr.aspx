<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/DocumentsMaster.master" AutoEventWireup="true" CodeBehind="DefaultAr.aspx.cs" Inherits="dms.Screen.Default"  EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageTitle" runat="server">
    <ul class="pages_nav">
        ...
        <li><a><%= (Session["lang"].ToString() == "0") ? "Recent Documents" : "أحدث المستندات"%></a></li>
    </ul>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    <div class="control-side-holder">
        <div class="start-side">
            ...
            <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn-main" NavigateUrl="~/Screen/advancedSearch.aspx"><i class="fas fa-search-plus"></i> <%= (Session["lang"].ToString() == "0") ? "Advanced Search" : "بحث متقدم"%></asp:HyperLink>
        </div>
        ...
        <div class="end-side">
            <div class="dropdown-main dropdown">
                <%--<div id="drop1" class="btn-dropdown-holder" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="dropdown-title">عرض 5</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="12.204" height="7.118" viewBox="0 0 12.204 7.118">
                        <g id="Group_3106" data-name="Group 3106" transform="translate(11.704 0.556) rotate(90)">
                            <g id="Group_2125" data-name="Group 2125">
                                <path id="Path_6981" data-name="Path 6981" d="M5.88,5.268.732.12A.429.429,0,0,0,.126.727L4.97,5.571.126,10.416a.429.429,0,1,0,.607.607L5.88,5.875A.429.429,0,0,0,5.88,5.268Z" fill="#8f9198" stroke="#8f9198" stroke-width="1" />
                            </g>
                        </g>
                    </svg>
                </div>
            ...
            <div class="dropdown-main dropdown">
                <%--<div id="drop2" class="btn-dropdown-holder" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="dropdown-title">تصفية</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="12.204" height="7.118" viewBox="0 0 12.204 7.118">
                        <g id="Group_3106" data-name="Group 3106" transform="translate(11.704 0.556) rotate(90)">
                            <g id="Group_2125" data-name="Group 2125">
                                <path id="Path_6981" data-name="Path 6981" d="M5.88,5.268.732.12A.429.429,0,0,0,.126.727L4.97,5.571.126,10.416a.429.429,0,1,0,.607.607L5.88,5.875A.429.429,0,0,0,5.88,5.268Z" fill="#8f9198" stroke="#8f9198" stroke-width="1" />
                ...
                <asp:DropDownList ID="ddlStatusFilter" runat="server" OnSelectedIndexChanged="ddlStatusFilter_SelectedIndexChanged" AutoPostBack="true" CssClass="new-drop">
