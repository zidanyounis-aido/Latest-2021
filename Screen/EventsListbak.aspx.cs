...
{
    public partial class EventsListbak : System.Web.UI.Page
    {
        ...
        public static string UpdateEvent(CalendarEvent cevent)
        {
            ...
            if (idList != null && idList.Contains(cevent.id))
            {
                ...
                {
                    EventDAO.updateEvent(cevent.id, cevent.title, cevent.description,cevent.backgroundColor);

                    return "updated event with id:" + cevent.id + " update title to: " + cevent.title +
                    " update description to: " + cevent.description + " update Color to: " + cevent.backgroundColor;
                }
        ...
        public static int addEvent(ImproperCalendarEvent improperEvent)
        {
            CalendarEvent cevent = new CalendarEvent()
            {
                ...
                CreatedBy = improperEvent.CreatedBy,
