...
namespace dbo
{
    public class documentWFPath 
    {
        ...
        private DataTable _table = new DataTable("documentWFPath");
        ...
        public documentWFPath () { }
        public documentWFPath (DataTable Table) 
        {
            table = Table;
        }
        ...
        public string[] columnsArray = {"Int32 ID","Int64 docID","Int32 userID","DateTime actionDateTime","Int32 wfPathID","Int16 wfSeqNo","Int16 actionType","Int16 recipientType","string userNotes","DateTime receiveDate","DateTime EndDate","bool isRemoved"};
...
public void update()
{
op.dboUpdateDocumentWFPathByPrimaryKey(c.convertToInt32(_table.Rows[_currentIndex]["ID"]),_fieldDocID,_fieldUserID,_fieldActionDateTime,_fieldWfPathID,_fieldWfSeqNo,_fieldActionType,_fieldRecipientType,_fieldUserNotes,_fieldReceiveDate,_fieldEndDate,_fieldIsRemoved);
}
