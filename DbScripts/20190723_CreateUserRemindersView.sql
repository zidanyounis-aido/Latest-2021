...
/****** Object:  View [dbo].[userReminders]    Script Date: 7/23/2019 6:16:50 AM ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT        dbo.usersRemiders.userID, dbo.usersRemiders.docID, dbo.documents.docName, dbo.metas.metaDesc, dbo.metas.metaDescAr
