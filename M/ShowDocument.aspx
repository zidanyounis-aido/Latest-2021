<%@ Page MasterPageFile="~/Masters/mobile.master" Language="C#" AutoEventWireup="true" CodeBehind="ShowDocument.aspx.cs" Inherits="dms.M.ShowDocument" %>
...
<asp:Content runat="server" ContentPlaceHolderID="head">
  ...
  #draggable { width: 500px; position:absolute; font-weight:bold; color:Black; font-size:26px; z-index:1000 }
    ...
    <script>
            ...
            function Popup(data) {
                var mywindow = window.open('', 'ZY_Documents', 'height=400,width=600');
...
<div id="toolbar" style="background-color:#cfcfcf; padding:10px;">
    ...
    <%= (Session["lang"].ToString() == "0") ? "Rotate to Left" : "دوران إلى اليسار"%>
        ...
        <asp:Image ClientIDMode="Static" ID="Image1" Width="100%" runat="server" />
