    ...
    $.feedback = function (options) {
        ...
        var settings = $.extend({
            ...
            tpl: {
                ...
                highlighter: '<div id="feedback-highlighter" style="direction: ltr"><button class="feedback-Drag feedback-active"><svg xmlns="https://www.w3.org/2000/svg" focusable="false" aria-label="Drag" fill="#BDBDBD" height="40" width="16" viewBox="-2 2 12 12"><circle cx="1.5" cy="1.5" r="1.5"></circle><circle cx="1.5" cy="7.5" r="1.5"></circle><circle cx="1.5" cy="13.5" r="1.5"></circle><circle cx="6.5" cy="1.5" r="1.5"></circle><circle cx="6.5" cy="7.5" r="1.5"></circle><circle cx="6.5" cy="13.5" r="1.5"></circle></svg></Button><button class="feedback-sethighlight feedback-active" title="تمييز"><span style="display: inline-block; position: relative; height: 36px; width: 36px;"><svg xmlns="https://www.w3.org/2000/svg" focusable="false" viewBox="0 0 24 24" height="36" width="36" fill="#FDD835"><path d="M3 3h18v18H3z"></path></svg><svg xmlns="https://www.w3.org/2000/svg" focusable="false" aria-label="" fill="#757575" viewBox="0 0 24 24" height="36" width="36" style="left: 0px; position: absolute; top: 0px;"><path d="M21 17h-2.58l2.51 2.56c-.18.69-.73 1.26-1.41 1.44L17 18.5V21h-2v-6h6v2zM19 7h2v2h-2V7zm2-2h-2V3.08c1.1 0 2 .92 2 1.92zm-6-2h2v2h-2V3zm4 8h2v2h-2v-2zM9 21H7v-2h2v2zM5 9H3V7h2v2zm0-5.92V5H3c0-1 1-1.92 2-1.92zM5 17H3v-2h2v2zM9 5H7V3h2v2zm4 0h-2V3h2v2zm0 16h-2v-2h2v2zm-8-8H3v-2h2v2zm0 8.08C3.9 21.08 3 20 3 19h2v2.08z"></path></svg></span></button><button class="feedback-setblackout" title="إخفاء"><span style="display: inline-block; position: relative; height: 36px; width: 36px;"><svg xmlns="https://www.w3.org/2000/svg" focusable="false" viewBox="0 0 24 24" height="36" width="36" fill="#000"><path d="M3 3h18v18H3z"></path></svg></span></button><button id="feedback-highlighter-next" class="feedback-setnextbtn feedback-active"><span style="display: inline-block; position: relative; height: 30px; width: 36px;">تم</span></button><button id="feedback-highlighter-back" class="feedback-back-btn feedback-btn-gray">Back</button><div class="feedback-highlighter-close"></div></div>',
                overview: '<div id="feedback-overview"><div class="feedback-logo">Feedback</div><div id="feedback-overview-description"><div id="feedback-overview-description-text"><h3>التعليق</h3><h3 class="feedback-additional">Additional info</h3><div id="feedback-additional-none"><span>None</span></div><div id="feedback-browser-info"><span>Browser Info</span></div><div id="feedback-page-info"><span>Page Info</span></div><div id="feedback-page-structure"><span>Page Structure</span></div></div></div><div id="feedback-overview-screenshot"><h3>لقطة الشاشة</h3><button id="feedback-overview-back">انقر لتمييز المعلومات أو إخفائها</button></div><div class="feedback-buttons"><button id="feedback-submit" class="feedback-submit-btn feedback-btn-gray">إرسال</button></div><div id="feedback-overview-error">رجاء كتابة تعليق</div><div class="feedback-close-btn feedback-btn-gray">إلغاء</div></div>',
                submitSuccess: '<div id="feedback-submit-success"><div class="feedback-logo">Feedback</div><p>شكرا لك على ملاحظاتك. نحن نقدر كل جزء من ردود الفعل التي نتلقاها.</p><button class="feedback-close-btn feedback-btn-blue">حسنا</button><div class="feedback-wizard-close"></div></div>',
                submitError: '<div id="feedback-submit-error"><div class="feedback-logo">Feedback</div><p>للأسف حدث خطأ أثناء إرسال ملاحظاتك. حاول مرة اخرى.</p><button class="feedback-close-btn feedback-btn-blue">حسنا</button><div class="feedback-wizard-close"></div></div>'
            },
            onClose: function () { },
        ...
        if (supportedBrowser) {
            ...
            $(document).on('click', settings.feedbackButton, function () {
                ...
                $(document).ready(function () {
                    $(document).on('click', '#feedback-submit', function () {
                        ...
                        if ($('#feedback-note').val().length > 0) {
                            ...
                            $('#feedback-overview').hide();
                            var data = '{"img":"' + img + '","note":"' + $('#feedback-note').val() + '","url":"' + document.URL + '"}';
                            $.ajax({
                ...
                $("#feedback-highlighter-next").click();
            });
        }
